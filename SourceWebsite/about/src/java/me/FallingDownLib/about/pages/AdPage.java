...
import me.FallingDownLib.about.pages.www.PrintAd;
...
public class AdPage extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        indexAbout.setIn_Page_Title("VoxNucleus : Publicité");
        indexAbout.setMetadata(index_meta);
        PrintAd adPrinter = PrintAd.getInstance();
        indexAbout.setBodyContent(adPrinter);
