...
import me.FallingDownLib.about.pages.www.PrintIndex;
...
public class Index extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        index_meta.setAdditionnalKeywords(" description, à propos ");
        indexAbout.setTitle("A propos");
        indexAbout.setIn_Page_Title("VoxNucleus : A propos");
        indexAbout.setMetadata(index_meta);
        PrintIndex index_printer = PrintIndex.getInstance();
        indexAbout.setBodyContent(index_printer);
