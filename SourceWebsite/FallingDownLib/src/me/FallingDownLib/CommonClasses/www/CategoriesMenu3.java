...
public class CategoriesMenu3 {
    ...
    public CategoriesMenu3(String category, String sub_category, String filter) {
    ...
    private void createFilterMenu() {
        ...
        menu_builder.append("<li class=\"").append(getClassSelected(TF_LATEST)).
                append("\">").append(buildLatestLink()).append("</li>");
        menu_builder.append("<li class=\"").append(getClassSelected(TF_INTERESTING))
                .append("\">").append(buildInterestingLink()).append("</li>");
        menu_builder.append("<li class=\"best ").append(getClassSelected(TF_BEST24HOURS))
                .append(getClassSelected(TF_BEST1WEEK))
                .append(getClassSelected(TF_BEST1MONTH))
                .append(getClassSelected(TF_BEST1YEAR))
                .append(getClassSelected(TF_ARCHIVES)).append("\"> <span class=\"text\">Meilleurs</span>");
    ...
    private String buildInterestingLink() {
        ...
        latestBuilder.append(" <span class=\"text\"> Intéressants </span> ");
        latestBuilder.append("</a>");
        return latestBuilder.toString();
    }
    ...
    private String buildBestLinkList() {
        ...
        bestLinkList.append("<li class=\"").append(getClassSelected(TF_BEST24HOURS)).append("\" > <a href=\"").append(beginning).append(FallingDownConnector.KEY_POSTS_24H).append("\">");
        bestLinkList.append("Depuis un jour").append("</a> </li>");
        bestLinkList.append("<li class=\"").append(getClassSelected(TF_BEST1WEEK)).append("\" > <a href=\"").append(beginning).append(FallingDownConnector.KEY_POSTS_1WEEK).append("\">");
        bestLinkList.append("Depuis une semaine").append("</a> </li>");
        bestLinkList.append("<li class=\"").append(getClassSelected(TF_BEST1MONTH)).append("\" > <a href=\"").append(beginning).append(FallingDownConnector.KEY_POSTS_1MONTH).append("\">");
        bestLinkList.append("Depuis un mois").append("</a> </li>");
        bestLinkList.append("<li class=\"").append(getClassSelected(TF_BEST1MONTH)).append("\"> <a href=\"").append(beginning).append(FallingDownConnector.KEY_POSTS_1YEAR).append("\">");
